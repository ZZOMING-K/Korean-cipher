...
- 해당 모델은 흔히 **에어비앤비체** 로 불리는 난독화된 한글 리뷰를 원본으로 복원하는 모델이다. 
- 한국어는 자음과 모음을 다양한 방식으로 결합하여 만들어지며, 글자를 손상시키는 방법은 불필요한 자음을 추가하고나, 연음법칙을 적용하는 등 글자 수준(character-level)의 왜곡이다.
- 언어학적으로는 의미없는 말이나, 한국인들은 상당 부분 해독이 가능하다. 
